...
public class ConfigurationHandler
{
    ...
    {
        webhookURL = new Pair<String, String>(Messages.Config.WEBHOOK_URL_KEY, Messages.Config.WEBHOOK_URL_COMMENT);
        port = new Pair<String, String>(Messages.Config.PORT_KEY, Messages.Config.PORT_COMMENT);
        token = new Pair<String, String>(Messages.Config.TOKEN_KEY, Messages.Config.TOKEN_COMMENT);
        format = new Pair<String, String>(Messages.Config.FORMAT_KEY, Messages.Config.FORMAT_COMMENT);
        ops = new Pair<String, String>(Messages.Config.OPS_KEY, Messages.Config.OPS_COMMENT);
        serverName = new Pair<String, String>(Messages.Config.NAME_KEY, Messages.Config.NAME_COMMENT);
